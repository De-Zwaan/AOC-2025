...
.done:
        ...
        mov     r14, -1
main_loop:
        cmp     qword [result], r14             ; If the amount of paper hasn't changed, exit
        je      done

        mov     r14, qword [result]             ; Keep track of the result before the loop
        mov     r11, 0
