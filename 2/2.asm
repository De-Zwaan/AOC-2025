...
.convert_loop:
        ...
        mov     r14, 2
; The length of the sequence must be len/n, where n >= 2
; First check if the length is divisible by n (rcx % r14 == 0)
.divisor_loop:
        cmp     r14, rcx
        jg      .divisor_loop_done

        mov     rax, rcx
        cqo
        idiv    r14                     ; rax / rcx, rdx = remainder, rax = quotient
...
; Loop over all elements in a segment
.check_loop:
        inc     r12
        cmp     r12, rax
        jge     .matched
